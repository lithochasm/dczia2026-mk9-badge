...
Every press creates a spatial ripple. Tilt steers the animation, and shaking
the badge advances to the next theme. If the accelerometer is not responding,
the keys, LEDs, and USB keyboard continue to work.
